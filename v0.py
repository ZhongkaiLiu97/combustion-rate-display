    ...
    with st.expander("📋 查看详细数据"):
        ...
        for reaction in valid_reactions:
            data_table.append({
                ...
                'k @ 300K': f"{calculate_rate_constant(300, reaction['A'], reaction['n'], reaction['Ea'], R_value):.2e}",
                'k @ 1000K': f"{calculate_rate_constant(1000, reaction['A'], reaction['n'], reaction['Ea'], R_value):.2e}",
                'k @ 2000K': f"{calculate_rate_constant(2000, reaction['A'], reaction['n'], reaction['Ea'], R_value):.2e}"
            })
